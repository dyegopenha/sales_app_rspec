...
class ProductSalesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create product_sale" do
    assert_difference('ProductSale.count') do
      post product_sales_url, params: { product_sale: { product_id: @product_sale.product_id, quantity: @product_sale.quantity, sale_id: @product_sale.sale_id, value: @product_sale.value } }
    end
  ...
  test "should update product_sale" do
    patch product_sale_url(@product_sale), params: { product_sale: { product_id: @product_sale.product_id, quantity: @product_sale.quantity, sale_id: @product_sale.sale_id, value: @product_sale.value } }
